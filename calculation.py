...
def calculate(numFaculty, numStudents, numSessions, durationSessions):
    ...
    # num_faculty = 10000000000
    # num_students = 1000000000
    # duration = 75000000000
    # num_class_periods = 26000000000
    ...
    for x in range(trials):
        ...
        #print("Nfs: ", Nfs)
        Nsf = calc_Nsf(
            cs, inhalation_rate_faculty[2], inhalation_mask_efficiency[2], duration)
        #print("Nsf: ", Nsf)
        Nss = calc_Nss(
            cs, inhalation_rate_student[2], inhalation_mask_efficiency[2], duration)
        #print("Nss: ", Nss)
